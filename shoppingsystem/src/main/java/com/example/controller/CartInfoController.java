...
public class CartInfoController {
     ...
     */
    @GetMapping
    public Result findAll(@RequestParam("userId") Long userId,
     ...
     */
    @PostMapping
    public Result add(@RequestBody CartInfo detailInfo) {
     ...
     */
    @PutMapping
    public Result update(@RequestBody CartInfo detailInfo) {
